...
public class _03_IfElseIf {
    public static void main(String[] args) {
        ...
        System.out.print("Ders ve not girin=");
        String dersVeNot=oku.nextLine();

        int ind=dersVeNot.indexOf(":");
        int ogrNot=Integer.parseInt(dersVeNot.substring(ind+1) );

        // 2. YOL İSE BU ŞEKİLDE OLUR
        // int ogrNot2=Integer.parseInt(dersVeNot.replaceAll("[^0-9]",""));
                ...
                if (ogrNot >=70)
                    ...
                    if (ogrNot >=60)
                        ...
                        if (ogrNot >=40)
                            ...
                            System.out.println("F, maalesef kaldınız");
