...
public class _03_JavaArray {
    public static void main(String[] args) {
        ...
        int[] dizi2= {5,6,34,77,66}; // 5 elemanlı bir dizi hem tanımladım
        // hem de ilke değerlerini verdim

        String[] kelimeler= new String[5]; // 5 tane kelime/cumle saklayabilen bir dizi değişkeni
        boolean[] dizi3= new boolean[5]; // 5 tane boolean(true/false) saklaybilen bir dizi değişkeni
        double [] oranlar= new double[5]; // 5 tane double saklayabilen bir dizi değişkeni

        for (int i = 0; i <dizi.length; i++) {
            System.out.println("dizi1 = " + dizi[i]);
        }
