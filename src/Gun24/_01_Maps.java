...
public class _01_Maps {
    public static void main(String[] args) {
        ...
        // Anahtarın tipi Integer değerlerinin tipi String olsun
        ...
        System.out.println("hm.keySet() = " + hm.keySet()); // Key setleri numaraları verir
        System.out.println("hm.values() = " + hm.values()); // values isimleri alıyor
        System.out.println("hm.entrySet() = " + hm.entrySet()); // hepsini alıyor
